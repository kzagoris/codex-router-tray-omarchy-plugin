...
Item {
  ...
  // a fix that has already run. Nothing polls for it — the reader asks, when
  // a reader arrives and on Refresh (see RouterService.onReaderPresentChanged
  // and RouterService.requestRefresh).
  //
